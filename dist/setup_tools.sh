...
echo scirocco.intiki=${INTIKI_VERSION} >> ~/intiki/builtin_tools_versions.txt
mkdir -p ~/packages/scirocco/hardware/intiki/
ln -s $PWD ~/packages/scirocco/hardware/intiki/`basename $PWD`
